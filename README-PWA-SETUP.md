...
1. **interactive_farm_map.html** - The main map app
...
2. **Upload to GitHub** (replace interactive_farm_map.html)
3. **That's it!**
...
1. Edit `interactive_farm_map.html`
2. Upload to GitHub
